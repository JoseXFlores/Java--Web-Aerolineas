...
List<Aeropuerto> aeropuertos = (List<Aeropuerto>) request.getAttribute("aeropuertos");
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    ...
    <header><h1>Listado de Aeropuertos</h1></header>
    <table>
        <thead>
        <tr>
            <th>ID</th>
        ...
        <tr>
           ...
           <form action="<%= request.getContextPath() %>/aeropuertos/eliminar" method="GET" style="display: inline;" class="delete-form">
                <input type="hidden" name="id" value="<%= a.getId() %>" />
...
<script>
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', function(event){
                ...
                Swal.fire({
                    title: '¿Estás seguro que deseas eliminar el aeropuerto?',
